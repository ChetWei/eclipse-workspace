...
<BODY>
	<FORM id="linkmenForm" name="linkmenForm"
		action="linkman_findAll.action" method=post>
		...
		<TABLE cellSpacing=0 cellPadding=0 width="98%" border=0>
			<TBODY>
				<TR>
												...
												<TR
												 ...
												 <s:iterator value="list">
													<TR style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
														...
														<TD><a href="linkman_enterEdit.action?lkm_id=<s:property value="lkm_id"/>">修改</a> &nbsp;&nbsp; 
														<a href="linkman_delete.action?lkm_id=<s:property value="lkm_id"/>">删除</a>
														</TD>
													</TR>
												</s:iterator>
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												[<A
														href="javascript:to_page(<s:property value="currentPage+1"/>)">后一页</A>] 
												[<A
					...
					<TD width=15
						background="images/new_023.jpg"><IMG
						src="images/new_023.jpg"
						border=0></TD>
				</TR>
			</TBODY>
		</TABLE>
