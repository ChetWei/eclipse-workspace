...
public final class menu_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<TBODY>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<TR>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<TD class=menuSmall><A class=style2 href=\"customer_enterAdd.action\" \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\ttarget=main>－ 新增客户</A></TD>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</TR>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<TR> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<TD class=menuSmall><A class=style2 href=\"customer_findAll.action\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<TBODY>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<TR>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<TD class=menuSmall><A class=style2 href=\"linkman_enterAdd.action\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\ttarget=main>－新增联系人</A></TD>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</TR>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<TR>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<TD class=menuSmall><A class=style2 href=\"linkman_findAll.action\"\r\n");
